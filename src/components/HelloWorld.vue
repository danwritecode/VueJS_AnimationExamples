<template>
  <v-container>
    ...
    <v-row justify="center" align="center" style="height: 200px;">
      <v-col cols="1">
        <v-btn @click="showAnimateCSSCard_RollInOut = !showAnimateCSSCard_RollInOut">Toggle</v-btn>
      </v-col>
      <intersect @enter="showAnimateCSSCard_RollInOut = true" @leave="showAnimateCSSCard_RollInOut = false">
      <v-col>
        <transition name="custom-classes-transition"
...
export default {
  ...
  data() {
    return {
      showfadeCard: true,
      showSlideFadeCard: true,
      showBounceCard: true,
      showAnimateCSSCard_BounceInOut: true,
      showAnimateCSSCard_RubberBand: true,
  ...
  methods: {
      onIntersect(entries) {
        ...
        this.showAnimateCSSCard_RollInOut = entries[0].showAnimateCSSCard_RollInOut
      }
  }
}
</script>
...
.fade-enter-active,
.fade-leave-active { transition: opacity 1500ms }
